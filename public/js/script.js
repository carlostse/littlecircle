    ...
    loginCallback: function(){
        ...
        FB.Event.subscribe('auth.authResponseChange', function(response) {
            ...
            if (response.status === 'connected') {
                ...
                var uid = response.authResponse.userID;
                console.log('[authResponseChange] user: ' + uid);
                aboutme.login(uid);
            } else if (response.status === 'not_authorized') {
                ...
                console.log('[authResponseChange] not_authorized, login');
                FB.login();
            } else {
...
var aboutme = {
    ...
    main: function(){
        ...
        $.getScript('//connect.facebook.net/en_UK/all.js', function(){
            ...
            FB.getLoginStatus(facebook.loginCallback);
        });

        // open socket
        aboutme.socket = io.connect('http://' + aboutme.domain + ':' + aboutme.socketPort);
